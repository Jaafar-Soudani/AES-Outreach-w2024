...
export default function Home() {
  ...
  }, [questionCounter, firstQuestionSetter]);
    ...
    <div className="card rounded">
        ...
        <span id="aBox">
            { shuffleArray([...answerFalse, answerTrue], questionCounter).map((value:any, index:number)=>{
              return <Answer inputRef={inputReferences[index]} handleAnswer={handleAnswer} answerText={decode(value)} id={`Answer${index}`}></Answer>
            })}
        </span>
